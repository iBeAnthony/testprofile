...
client.on('message', message => {
  ...
  if (message.author.id !== "452267912082751489") return;
...
if (message.content.startsWith(prefix + 'setavatar')) {
  client.user.setAvatar(argresult);
     console.log('test' + argresult);
    message.channel.sendMessage(`Avatar: **${argresult}`)
} 
...
---------------------------------
${prefix}help-general | اوامر عامة
---------------------------------
...
client.on("message", message => {
    if (message.content === (prefix + "help-admin")) {
     const embed = new Discord.RichEmbed() 
         ...
         .setThumbnail(message.author.avatarURL)
         .setDescription(`**
${prefix}setmedia | تجديد روم الصور فقط
${prefix}infomedia | معلومات عن روم الصور فقط
${prefix}togglemedia | ايقاف تشغيل روم الصور فقط
${prefix}server | معلومات عن السيرفر
${prefix}ban | لحظر عضو من السيرفر
${prefix}kick | لطرد عضو من السيرفر
${prefix}clear | لمسح الشات
${prefix}mc | لتقفيل الشات
${prefix}unmc | لفتح الشات
${prefix}link | لاعطائك رابط دعوة لمدة يوم 
${prefix}createc | لانشاء روم كتابي
${prefix}createv | لانشاء روم صوتي 
${prefix}autorole | لتحديد الرول الي يتخذها العضو لما يدخل السيرفر
       **  `)
   message.author.sendEmbed(embed)
...
client.on('message', message => {
if (message.content.startsWith(prefix+"createcا")) {
    var args = message.content.split(" ").slice(1);
...
${prefix}avatar | صورة حسابك
${prefix}emojilist | الايموجيات الموجودة بالسيرفر
       **  `)
   message.author.sendEmbed(embed)
...
client.on('message', async message =>{
  ...
  if(emojiList === "") return;
  message.channel.send("اسموجيات السيرفر: " + emojiList);
    }
});
...
member.guild.fetchInvites().then(guildInvites => {
   ...
   //  yumz.send(`<@${member.user.id}> joined using invite code ${invite.code} from <@${inviter.id}>. Invite was used ${invite.uses} times since its creation.`);
      ...
      const w = `https://cdn.discordapp.com/attachments/571479578309034020/571507225059655700/w1.png`
      ...
      ctx.fillText(`Name:`, 155, 145);
                              //NAMEً
                              ctx.font = "bold 17px Arial";
                              ctx.fontSize = '80px';
                              ctx.fillStyle = "#1fff00";
      ctx.fillText(`Węļçømĕ Țó Țhė Şęřvêŕ`, 205, 100);
